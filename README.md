...
- **`apps/nrp`** — 14 lessons authored from the official Persian translation of the Neonatal Resuscitation Program (NRP) 8th-edition textbook (`source-material/NRP_8th_Ed._LR.Farsi_1400.pdf`), covering the 11 core lessons plus 3 supplementary lessons. Same structure as `obgyn-v2` (reference pages included). Raw per-lesson source text lives in `source-material/nrp/raw/`.
